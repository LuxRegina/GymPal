...
namespace GymPal.Resources.SaveToLogs
{
    public class SaveToLogsModel
    {
        ...
        public class FreeWeightInputData
        {
            ...
            public int? Weight { get; set; }     // 20 kg

            //public void e_FreeWeightInputData(string exerciseName, string notes, int reps, int sets, int weight)
            //{
